...
// I originally grabbed this file from
//   https://github.com/MydonSolutions/hashpipe/blob/master/src/hget.c
// and then modified it slightly to work in a header-only c++ library.
//   - Kevin
